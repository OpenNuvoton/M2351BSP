...
static volatile uint32_t s_USBD_u32CtrlOutToggle = 0;
...
void USBD_CtrlOut(void)
{
    ...
    if(s_USBD_u32CtrlOutToggle != (pUSBD->EPSTS0 & USBD_EPSTS0_EPSTS1_Msk))
    {
        s_USBD_u32CtrlOutToggle = pUSBD->EPSTS0 & USBD_EPSTS0_EPSTS1_Msk;
