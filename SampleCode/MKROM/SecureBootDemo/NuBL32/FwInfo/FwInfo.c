        ...
        Content:
            Word-0, the ID Hash Configuration.
                ...
                bit[4], indicates whether Info Hash includes UCID hash, which will be updated according FwSign.ini after executing FwSign.exe.
                        ...
                        UCID3=0xC4444444
                bit[31:5], reserved.
            Word-1, 8(bytes) to indicate only one NuBL32 FW region for NuBL2 can verify it.
            Word-2, indicates the NuBL32 FW base address.
            Word-3, indicates the NuBL32 FW size, which will be updated after NuBL32 is successfully built.
...
const uint32_t g_InitialFWInfo[] =
{
    ...
    0x00000001, 0x00000008, 0x00020000, 0x00000000, // Word-2: 0x00020000, NuBL32 FW base
    0x0000000C, 0x20191201, 0x00001111, 0x22223333, // Word-5/6/7: 0x20191201/0x00001111/0x22223333, Extend Info 
