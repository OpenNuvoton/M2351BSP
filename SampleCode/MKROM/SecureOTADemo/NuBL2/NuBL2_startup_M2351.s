...
__Vectors       DCD     __initial_sp               ;     Top of Stack
                ...
                DCD     HardFault_Handler          ;     Hard Fault Handler
                    ;DCD     0x4C42754E          ; 0x10: "NuBL" key word for check NuBL2 exist or NOT
                    ;DCD     (1024 * 378)        ; 0x14: F/W info base
                    ;DCD     0          ; 0x18: Reserved
                    ;DCD     (((~0x4c42754e)+(1024 * 378)+0))+1          ; 0x1c: CRC32 checksum from NuBL2 F/W base +0x10 to +0x18
                    DCD     0x4C42754E          ; 0x10: "NuBL" key word for check NuBL2 exist or NOT
                    DCD     (1024 * 378)        ; 0x14: F/W info base
                    DCD     0                   ; 0x18: Reserved
                    DCD     (((~0x4C42754E)+(1024 * 378)+0))+1 ; 0x1C: checksum = ((~M32(0x10))+M32(0x14)+M32(0x18))+1
                DCD     0                          ;     Reserved
                DCD     0                          ;     Reserved
                DCD     0                          ;     Reserved
