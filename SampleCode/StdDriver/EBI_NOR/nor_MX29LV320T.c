...
int32_t NOR_MX29LV320T_CheckStatus(uint32_t u32DstAddr, uint16_t u16Data, uint32_t u32TimeoutMs)
{
    ...
    if(u16Data != 0xEEEE)
    {
        ...
        do
        {
            u16RData = EBI1_READ_DATA16(EBI, u32DstAddr) & 0xFF;
    ...
    else
    {
        ...
        do
        {
            u16RData = EBI1_READ_DATA16(EBI, u32DstAddr);
...
int32_t NOR_MX29LV320T_WRITE(uint32_t u32Bank, uint32_t u32DstAddr, uint16_t u16Data)
{
    ...
    EBI1_WRITE_DATA16(EBI, (0x555 << 1), 0xA0);

    EBI1_WRITE_DATA16(EBI, u32DstAddr, u16Data);
...
void NOR_MX29LV320T_GET_ID(uint32_t u32Bank, uint16_t *pu16IDTable)
{
    ...
    EBI1_WRITE_DATA16(EBI, (0x555 << 1), 0xAA);
    EBI1_WRITE_DATA16(EBI, (0x2AA << 1), 0x55);
    EBI1_WRITE_DATA16(EBI, (0x555 << 1), 0x90);
    CLK_SysTickDelay(1000);

    /* Get Manufacture  */
    pu16IDTable[0] = EBI1_READ_DATA16(EBI, (0x0 << 1));

    /* Get DeviceID  */
    pu16IDTable[1] = EBI1_READ_DATA16(EBI, (0x1 << 1));
...
int32_t NOR_MX29LV320T_EraseChip(uint32_t u32Bank, uint32_t u32IsCheckBlank)
{
    ...
    EBI1_WRITE_DATA16(EBI, (0x555 << 1), 0xAA);
    EBI1_WRITE_DATA16(EBI, (0x2AA << 1), 0x55);
    EBI1_WRITE_DATA16(EBI, (0x555 << 1), 0x80);
    EBI1_WRITE_DATA16(EBI, (0x555 << 1), 0xAA);
    EBI1_WRITE_DATA16(EBI, (0x2AA << 1), 0x55);
    EBI1_WRITE_DATA16(EBI, (0x555 << 1), 0x10);
