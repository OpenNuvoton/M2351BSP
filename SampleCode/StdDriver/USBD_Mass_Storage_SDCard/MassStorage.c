    ...
    if(s_u32OutSkip == 0)
    {
        ...
        else
        {
            ...
            if((s_sCBW.u8OPCode == UFI_WRITE_10) || (s_sCBW.u8OPCode == UFI_WRITE_12))
            {
                ...
                u32Len = (u32Lba - s_u32DataFlashStartAddr) * UDC_SECTOR_SIZE + s_sCBW.dCBWDataTransferLength;
                if(u32Len)
                {
