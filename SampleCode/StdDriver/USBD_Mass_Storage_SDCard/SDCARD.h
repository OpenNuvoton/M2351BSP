 ...
 * @file     sdcard.h
 * @version  V1.00
 * @brief    M2351 series SD Card driver header file
 *
 * @note
...
/** @addtogroup M2351_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
/*@}*/ /* end of group M2351_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup M2351_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group M2351_SDCARD_EXPORTED_STRUCTS */
