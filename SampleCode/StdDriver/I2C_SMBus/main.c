...
int main(void)
{
    ...
    while(ch != 0x30)
    {
        ...
        */
        printf("\n");
        printf("+-------------------------------------------------------+\n");
        printf("|  M2351 I2C SMBUS Driver Sample Code                   |\n");
        printf("|                                                       |\n");
        ...
        printf("I2C0_SDA(PA.4), I2C0_SCL(PA.5), I2C0_SMBSUS(PC.2), I2C0_SMBAL(PC.3)\n");
        printf("I2C1_SDA(PA.2), I2C1_SCL(PA.3), I2C1_SMBSUS(PB.8), I2C1_SMBAL(PB.9)\n");
        printf("\n");
