...
static volatile uint8_t s_au8TxData[3];
static volatile uint8_t s_u8RxData;
static volatile uint8_t s_u8DataLen;
static volatile uint8_t s_u8EndFlag = 0;
...
void I2C_MasterRx(uint32_t u32Status)
{
    ...
    {
        I2C_SET_DATA(I2C0, (uint32_t)(s_u8DeviceAddr << 1));    /* Write SLA+W to Register I2CDAT */
    ...
    {
        s_u8RxData = (unsigned char) I2C_GET_DATA(I2C0);
