...
/* Global variable                                                                                         */
/*---------------------------------------------------------------------------------------------------------*/
volatile uint32_t g_au32AddrBuffer[ADDR_NUM];
volatile uint32_t g_au32DataBuffer[ADDR_NUM][DATA_NUM];
uint8_t g_u8AddrIndex = 0;
uint8_t g_u8DataIndex = 0;
...
void RS485_9bitModeMaster(void)
{
    ...
    {
        g_u8SendDataGroup1[i32Idx] = i32Idx;
        g_u8SendDataGroup2[i32Idx] = i32Idx + 10;
        g_u8SendDataGroup3[i32Idx] = i32Idx + 20;
        g_u8SendDataGroup4[i32Idx] = i32Idx + 30;
    }
