...
static uint32_t volatile s_u32OutToggle0 = 0, s_u32OutToggle1 = 0, s_u32OutToggle2 = 0;
...
void USBD_IRQHandler(void)
{
    ...
    if(u32IntSts & USBD_INTSTS_BUS)
    {
        ...
        if(u32State & USBD_STATE_USBRST)
        {
            ...
            USBD_ENABLE_USB();
            USBD_SwReset();
            s_u32OutToggle0 = s_u32OutToggle1 = s_u32OutToggle2 = 0;
            g_u8Suspend = 0;
        }
...
#if (VCOM_CNT >= 3)
                if(g_USBD_au8SetupPacket[4] == 4)  /* VCOM-3 */
...
{
    /* Bulk OUT */
    if(s_u32OutToggle2 == (USBD->EPSTS1 & USBD_EPSTS1_EPSTS9_Msk))
    {
    ...
    s_u32OutToggle2 = USBD->EPSTS1 & USBD_EPSTS1_EPSTS9_Msk;
    /* Set a flag to indicate bulk out ready */
    g_i8BulkOutReady2 = 1;
}
        ...
        switch(au8Buf[1])
        {
            case SET_CONTROL_LINE_STATE:
            {
                ...
                if(au8Buf[4] == 4)    /* VCOM-3 */
                {
                    ...
                    //printf("RTS=%d  DTR=%d\n", (g_u16CtrlSignal2 >> 1) & 1, g_u16CtrlSignal2 & 1);
                }
#endif
                /* Status stage */
                USBD_SET_DATA1(EP0);
