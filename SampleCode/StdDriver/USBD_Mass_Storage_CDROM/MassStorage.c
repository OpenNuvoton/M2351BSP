...
void MSC_Init(void)
{
    ...
    g_i32TotalSectors = DATA_FLASH_STORAGE_SIZE / CDROM_BLOCK_SIZE;
}
...
void MSC_ReadFormatCapacity(void)
{
    ...
    *((uint8_t *)(MassCMD_BUF + 3)) = 0x08;                    /* Capacity List Length */
    ...
    /* Block Count */
    *((uint8_t *)(MassCMD_BUF + 4)) = (g_i32TotalSectors >> 24) & 0xFF;
    *((uint8_t *)(MassCMD_BUF + 5)) = (g_i32TotalSectors >> 16) & 0xFF;
    *((uint8_t *)(MassCMD_BUF + 6)) = (g_i32TotalSectors >>  8) & 0xFF;
    *((uint8_t *)(MassCMD_BUF + 7)) = (g_i32TotalSectors >>  0) & 0xFF;
    ...
    if(g_u32OutSkip == 0)
    {
        ...
        else
        {
            ...
            if((g_sCBW.u8OPCode == UFI_WRITE_10) || (g_sCBW.u8OPCode == UFI_WRITE_12))
            {
                ...
                u32Len = u32Lba * CDROM_BLOCK_SIZE + g_sCBW.dCBWDataTransferLength - g_u32DataFlashStartAddr;
                if(u32Len)
            ...
            switch(g_sCBW.u8OPCode)
            {
                ...
                case UFI_READ_10:
                {
                    ...
                    if(g_u32Length == 0)
                    {
                        ...
                        u32Dcount = (get_be32(&g_sCBW.au8Data[4]) >> 8) * CDROM_BLOCK_SIZE;
                    ...
                    {
                        memset((uint32_t*)g_au32StorageBlock, 0, i);
                        g_u32Address = STORAGE_DATA_BUF;
                    }
